...
__decorate([
    (0, class_validator_1.Matches)(/^\d{2}:\d{2}$/, { message: 'startTime deve estar no formato HH:mm' }),
    __metadata("design:type", String)
], CreateScheduleDto.prototype, "startTime", void 0);
__decorate([
    (0, class_validator_1.Matches)(/^\d{2}:\d{2}$/, { message: 'endTime deve estar no formato HH:mm' }),
    __metadata("design:type", String)
