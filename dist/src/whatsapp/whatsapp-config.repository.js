...
exports.WhatsAppConfigRepository = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma/prisma.service");
let WhatsAppConfigRepository = class WhatsAppConfigRepository {
    constructor(prisma) {
        this.prisma = prisma;
    }
    findActive(tenantId) {
...
exports.WhatsAppConfigRepository = WhatsAppConfigRepository;
exports.WhatsAppConfigRepository = WhatsAppConfigRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], WhatsAppConfigRepository);
//# sourceMappingURL=whatsapp-config.repository.js.map