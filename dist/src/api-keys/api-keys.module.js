...
const api_keys_repository_interface_1 = require("./repositories/api-keys.repository.interface");
...
exports.ApiKeysModule = ApiKeysModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            { provide: api_keys_repository_interface_1.API_KEYS_REPOSITORY, useClass: api_keys_repository_1.ApiKeysRepository },
        ],
